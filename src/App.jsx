...
const GEMINI_KEY    = "AIzaSyDJStTuTg8duO71gEg5Ujhs5YrLSmHVNO0";
...
Return ONLY a valid JSON object in exactly this format (no markdown, no extra text):
{
  ...
  const res = await fetch(
    `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flashh:generateContent?key=${GEMINI_KEY}`,
    {
      method: "POST",
